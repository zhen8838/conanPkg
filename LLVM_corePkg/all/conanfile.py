...
class LLVMCoreConan(ConanFile):
  ...
  # Older cmake versions may have issues generating the graphviz output used to model the components
  build_requires = [
      'cmake/3.20.3'
  ]
  ...
  def _configure_cmake(self):
    ...
    cmake.definitions['LLVM_INCLUDE_TOOLS'] = self.options.tools
  ...
  def package(self):
    ...
    # don't remove package cmake, used by clang
